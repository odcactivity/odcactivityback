    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/supports").hasAnyRole("PERSONNEL","SUPERADMIN","DIRECTEUR") //Get all...
                        .requestMatchers("/api/supports/**").hasAnyRole("PERSONNEL","SUPERADMIN","DIRECTEUR") //Get by id, POST, PUT, DELETE...
                        //Acces Endpoints Fichiers&Tailles ...
                        .requestMatchers("/api/stats").hasAnyRole("PERSONNEL","SUPERADMIN","DIRECTEUR")  //Get All ...
                        .requestMatchers("/api/stats/**").hasAnyRole("PERSONNEL","SUPERADMIN","DIRECTEUR") //Get by id, POST, PUT, DELETE ...
                        //Acces Endpoints Fichiers&Tailles ...
                        .requestMatchers(HttpMethod.PUT, "/api/courriers/**").hasAnyRole("PERSONNEL","SUPERADMIN","DIRECTEUR")
